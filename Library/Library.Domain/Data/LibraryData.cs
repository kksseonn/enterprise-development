...
public static class LibraryData
{
    ...
    public static Book[] Books(EditionType[] editionTypes, Publisher[] publishers) => new[]
    {
        ...
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000003"), InventoryNumber = 1003, CatalogCode = "A-02", Title = "Преступление и наказание", Authors = ["Ф.М. Достоевский"], EditionType = editionTypes[3], Publisher = publishers[1], Year = 1866 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000004"), InventoryNumber = 1004, CatalogCode = "A-02", Title = "Преступление и наказание", Authors = ["Ф.М. Достоевский"], EditionType = editionTypes[3], Publisher = publishers[1], Year = 1866 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000005"), InventoryNumber = 1005, CatalogCode = "B-01", Title = "Капитанская дочка", Authors = ["А.С. Пушкин"], EditionType = editionTypes[3], Publisher = publishers[7], Year = 1836 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000006"), InventoryNumber = 1006, CatalogCode = "B-01", Title = "Капитанская дочка", Authors = ["А.С. Пушкин"], EditionType = editionTypes[3], Publisher = publishers[7], Year = 1836 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000007"), InventoryNumber = 1007, CatalogCode = "B-02", Title = "Анна Каренина", Authors = ["Л.Н. Толстой"], EditionType = editionTypes[3], Publisher = publishers[0], Year = 1877 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000008"), InventoryNumber = 1008, CatalogCode = "B-02", Title = "Анна Каренина", Authors = ["Л.Н. Толстой"], EditionType = editionTypes[3], Publisher = publishers[0], Year = 1877 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000009"), InventoryNumber = 1009, CatalogCode = "C-01", Title = "Отцы и дети", Authors = ["И.С. Тургенев"], EditionType = editionTypes[3], Publisher = publishers[2], Year = 1862 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000010"), InventoryNumber = 1010, CatalogCode = "C-01", Title = "Отцы и дети", Authors = ["И.С. Тургенев"], EditionType = editionTypes[3], Publisher = publishers[2], Year = 1862 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000011"), InventoryNumber = 1011, CatalogCode = "C-02", Title = "Идиот", Authors = ["Ф.М. Достоевский"], EditionType = editionTypes[3], Publisher = publishers[1], Year = 1869 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000012"), InventoryNumber = 1012, CatalogCode = "C-02", Title = "Идиот", Authors = ["Ф.М. Достоевский"], EditionType = editionTypes[3], Publisher = publishers[1], Year = 1869 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000013"), InventoryNumber = 1013, CatalogCode = "D-01", Title = "Мастер и Маргарита", Authors = ["М.А. Булгаков"], EditionType = editionTypes[4], Publisher = publishers[5], Year = 1967 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000014"), InventoryNumber = 1014, CatalogCode = "D-01", Title = "Мастер и Маргарита", Authors = ["М.А. Булгаков"], EditionType = editionTypes[4], Publisher = publishers[5], Year = 1967 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000015"), InventoryNumber = 1015, CatalogCode = "D-02", Title = "Евгений Онегин", Authors = ["А.С. Пушкин"], EditionType = editionTypes[5], Publisher = publishers[7], Year = 1833 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000016"), InventoryNumber = 1016, CatalogCode = "D-02", Title = "Евгений Онегин", Authors = ["А.С. Пушкин"], EditionType = editionTypes[5], Publisher = publishers[7], Year = 1833 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000017"), InventoryNumber = 1017, CatalogCode = "E-01", Title = "Собачье сердце", Authors = ["М.А. Булгаков"], EditionType = editionTypes[4], Publisher = publishers[6], Year = 1925 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000018"), InventoryNumber = 1018, CatalogCode = "E-01", Title = "Собачье сердце", Authors = ["М.А. Булгаков"], EditionType = editionTypes[4], Publisher = publishers[6], Year = 1925 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000019"), InventoryNumber = 1019, CatalogCode = "E-02", Title = "Доктор Живаго", Authors = ["Б.Л. Пастернак"], EditionType = editionTypes[4], Publisher = publishers[8], Year = 1957 },
        new Book { Id = Guid.Parse("d0000000-0000-0000-0000-000000000020"), InventoryNumber = 1020, CatalogCode = "E-02", Title = "Доктор Живаго", Authors = ["Б.Л. Пастернак"], EditionType = editionTypes[4], Publisher = publishers[8], Year = 1957 }
    };
    ...
    public static Borrow[] Borrows(Book[] books, Reader[] readers) => new[]
    {
        ...
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000003"), Book = books[2], Reader = readers[3], BorrowDate = new DateOnly(2024, 8, 5), Days = 7, ReturnDate = new DateOnly(2024, 8, 12) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000004"), Book = books[3], Reader = readers[4], BorrowDate = new DateOnly(2024, 5, 1), Days = 20, ReturnDate = new DateOnly(2024, 5, 21) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000005"), Book = books[4], Reader = readers[6], BorrowDate = new DateOnly(2024, 3, 1), Days = 14, ReturnDate = new DateOnly(2024, 3, 15) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000016"), Book = books[10], Reader = readers[9], BorrowDate = new DateOnly(2025, 6, 1), Days = 14, ReturnDate = new DateOnly(2025, 6, 15) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000017"), Book = books[11], Reader = readers[2], BorrowDate = new DateOnly(2025, 3, 1), Days = 10, ReturnDate = new DateOnly(2025, 3, 11) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000018"), Book = books[12], Reader = readers[0], BorrowDate = new DateOnly(2025, 4, 1), Days = 21, ReturnDate = new DateOnly(2025, 4, 22) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000019"), Book = books[13], Reader = readers[6], BorrowDate = new DateOnly(2025, 5, 5), Days = 10, ReturnDate = new DateOnly(2025, 5, 15) },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000020"), Book = books[14], Reader = readers[8], BorrowDate = new DateOnly(2025, 6, 5), Days = 14, ReturnDate = new DateOnly(2025, 6, 19) },

        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000006"), Book = books[5], Reader = readers[0], BorrowDate = new DateOnly(2025, 9, 25), Days = 30 },
        new Borrow { Id = Guid.Parse("e0000000-0000-0000-0000-000000000007"), Book = books[6], Reader = readers[1], BorrowDate = new DateOnly(2025, 9, 30), Days = 20 },
